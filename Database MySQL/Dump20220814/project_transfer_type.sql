...
CREATE TABLE `transfer_type` (
  ...
  `transferdescription` varchar(255) DEFAULT NULL,
...
INSERT INTO `transfer_type` VALUES ('Bank Transfer','Transfer to BANK'),('Bank Transfer for Own Account','Transfer between bank branches'),('Customer Transfer','Transfer to customer');
